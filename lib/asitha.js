...
let get = {
PREFIX: ".",
ALIVE_IMG: "https://i.postimg.cc/rmL0Tm9y/Asitha-MD.png",
...
RECORDING: "true",
AUTO_REACT: "true",
NEWS_JID: "120363345216596571@g.us",
BAD_NO_BLOCK: "false"
}
let get2 = []
...
await githubCreateNewFile("Non-Btn", "data.json",JSON.stringify(get2))
await githubCreateNewFile("settings", "settings.json",JSON.stringify(get)) 
console.log("Asitha Md Database connected 🛢️")
}};
//=====================================================================
...
return await githubClearAndWriteFile("settings", "settings.json",JSON.stringify(get))
}else if (setting == "NEWS_JID") {
get.NEWS_JID = data
config.NEWS_JID = data
return await githubClearAndWriteFile("settings", "settings.json",JSON.stringify(get))
}else if (setting == "BAD_NO_BLOCK") {
get.BAD_NO_BLOCK = data
config.BAD_NO_BLOCK = data
return await githubClearAndWriteFile("settings", "settings.json",JSON.stringify(get))
}
}
...
config.NEWS_JID = get.NEWS_JID
config.BAD_NO_BLOCK = get.BAD_NO_BLOCK
...
config.PREFIX = "."
config.ALIVE_IMG = "https://i.postimg.cc/rmL0Tm9y/Asitha-MD.png"
...
config.NEWS_JID = "120363345216596571@g.us"
config.BAD_NO_BLOCK = "false"
console.log("Database writed ✅")
}
